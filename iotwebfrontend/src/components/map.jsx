    ...
    return(
      ...
      ></iframe>
            ...
            <div className='flex flex-col flex-1/2 p-10 justify-between'>
                <div>
                    <h3 className='font-optima font-extrabold text-white text-4xl'>Our Location</h3>
                    <p className='text-white text-base py-2'>Kampus FT UPNVJ, Jl. Limo Raya, Kota Depok, Jawa Barat, 16515</p>
                </div>
                <div>
                    <h3 className='font-optima font-extrabold text-white text-4xl'>Follow Us!</h3>
                    <div className='flex gap-4'>
                    <img src="./instagram.png" alt="" className='w-14 h-14 my-2'/>
                    <img src="./linkedin.png" alt="" className='w-14 h-14 my-2'/>
                    </div>
                </div>
            </div>
        </div>
