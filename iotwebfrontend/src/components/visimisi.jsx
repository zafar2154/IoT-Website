  ...
  return (
    <div className="w-full min-h-screen px-6 md:px-20 flex flex-col md:flex-row items-center justify-center gap-10">
      ...
      <div className="md:w-1/2 text-left">
        <h2 className="text-3xl md:text-4xl font-bold text-gray-800 mb-6 font-serif">Our Vision</h2>
        ...
        <h2 className="text-3xl md:text-4xl font-bold text-gray-700 mb-4 font-serif">Our Mission</h2>
