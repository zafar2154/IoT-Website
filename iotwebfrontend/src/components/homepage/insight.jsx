                ...
                {!isActive && (
                  <div
                    ...
                    ${
                      ...
                      index === 0
                        ? 'from-gray-200/60 to-gray-600/70'
                        : index === 1
                        ? 'from-purple-400/60 to-yellow-400/60'
                        : index === 2
                        ? 'from-yellow-300/60 to-pink-500/80'
                        : index === 3
                        ? 'from-blue-300/70 to-blue-300/70'
                        : index === 4
                        ? 'from-green-300/70 to-green-700/70'
                        : 'from-gray-400/90'
                    }`}
                    style={{
                      top: '0%',
