function Footerkepengurusan() {
    return (
        <div className='flex w-screen pl-[100px] pr-[100px] pt-[100px] h-[700px] bg-gradient-to-b from-white via-biru-footer-kepengurusan to-biru-muda
                        justify-between'>
            ...
            <div className='flex flex-col w-[400px] h-[400px] items-center'>
                <img src="Logo_IoT.png" alt="Logo_IoT" className='w-[180px] h-[201px]'></img>
                ...
                <img src="slogan.png" alt="Slogan" className='w-[368.5px] h-[77px]'></img>
                <div className='flex w-[400px] h-[100px] justify-center gap-[10px]'>
                    <img src="Linkedin_Footer.png" alt="linkedin" className='w-[57px] h-[57px]'></img>
