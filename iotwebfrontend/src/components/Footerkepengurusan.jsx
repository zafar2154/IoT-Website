function Footerkepengurusan() {
  return (
    <div
      className="flex w-screen pl-[100px] pr-[100px] pt-[100px] h-[700px] bg-gradient-to-b from-white via-biru-footer-kepengurusan to-biru-muda
                        justify-between"
    >
      <div className="pt-[80px] flex flex-col gap-[10px] w-[300px] h-[300px] items-end">
        <a href="" className="z-10 font-optima font-[900] text-[35px]">
          Contact Info
        </a>
        <a href="" className="z-10 font-optima font-[300] text-[20px]">
          contact info
        </a>
        <a href="" className="z-10 font-optima font-[300] text-[20px]">
          contact info
      ...
      <div className="flex flex-col w-[400px] h-[400px] items-center">
        ...
        ></img>
        <p className="font-optima text-[24px] font-[700]">
          KSM Internet Of Things
        </p>
        <p className="font-optima text-[16px] font-[400] mb-[10px]">
          UPN "Veteran" Jakarta
        </p>
        <img
          src="slogan.png"
        ...
        <div className="flex w-[400px] h-[100px] justify-center gap-[10px]">
          ...
          ></img>
          <img src="Ig_Footer.png" alt="ig" className="w-[57px] h-[57px]"></img>
        </div>
      </div>
