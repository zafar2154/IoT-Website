    ...
    <div className="w-full min-h-screen flex flex-col items-center justify-center px-10 py-28">
      ...
      <FadeIn direction={"left"} delay={0.8}>
        <div className="w-full flex flex-col items-center justify-center">
          <h1
            className="text-4xl md:text-5xl font-semibold text-[#2C3E50] mb-16 text-center"
      ...
      <FadeIn direction={"up"} delay={1.2}>
        <div className="flex flex-col items-center justify-center grid grid-cols-1 md:grid-cols-2 gap-x-26 gap-y-24 w-full">
          {boxes.map((box, index) => (
            <div
              key={index}
              className="group relative bg-[#2C3E50] mr-15 ml-15 text-white rounded-2xl p-10 h-[360px] overflow-hidden transition-all duration-500 ease-in-out hover:bg-gray-200 hover:text-black hover:border-8 hover:border-[#2C3E50]"
            >
